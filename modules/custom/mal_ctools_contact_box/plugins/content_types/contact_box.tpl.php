...
<aside class="contact-us basic">
  ...
  <div class="vcard">
    ...
    <div><a class="show-on-map m-icon-location" data-map-selector=".contact-us-map.m-0" data-scroll-to=".visiting-address.v-0" data-poi="<?php print render($maps_link); ?>" title="<?php print render($maps_link); ?>"><?php print t('Write to us'); ?></a></div>
