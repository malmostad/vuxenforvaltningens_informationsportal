<aside class="contact-us basic">
  ...
  <div class="vcard">
    ...
    <div><?php print empty($email['#title']) ? '' : $email['#title'] . ': '; ?><span class="email"><?php print render($email); ?></span></div>
    <div><?php print empty($phone['#title']) ? '' : $phone['#title'] . ': '; ?><span class="tel"><?php print render($phone); ?></span></div>
    <div><?php print empty($fax['#title']) ? '' : $fax['#title'] . ': '; ?><span class="fax"><?php print render($fax); ?></span></div>
